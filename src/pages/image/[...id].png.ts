    ...
    >
      ...
      >
        <div style="display: flex; align-items: center;">
          ...
          <span style="color: ${colors.text.secondary}; font-weight: 500; letter-spacing: 0.02em;">matibbaez</span>
        </div>
        ...
        <div style="display: flex; align-items: center; background: rgba(21,21,21, 0.8); border-radius: 18px; padding: 12px 22px; border: 1px solid rgba(255, 255, 255, 0.1);">
          <img src="https://res.cloudinary.com/diskaptn0/image/upload/v1761693103/matiLogo_kjszfm.png" alt="Logo" style="width: 64px; height: 48px;" width="64" height="48" />
          <div style="display: flex; flex-direction: column; margin-left: 18px; border-left: 1px solid rgba(255, 255, 255, 0.12); padding-left: 18px;">
            <span style="color: ${colors.text.primary}; font-weight: 600; font-size: 18px;">Matias Baez</span>
            <span style="color: ${colors.text.muted}; font-size: 14px;">matias-baez</span>
          </div>
        </div>
      </div>
    </div>`,
